...
export default class Lightbox {
    ...
    setMedia (elMedia) {
        ...
        this.media.forEach((el) => {
            ...
            link.addEventListener('keydown', this.openLightbox.bind(this));
    ...
    openLightbox (e) {
        ...
        e.preventDefault();
        this.currentMedia = e.currentTarget.querySelector('[data-lightbox]');
        this.loadMedia();
        ...
        this.lightbox.innerHTML = `
            <div class="lightbox-wrapper" aria-label="image closeup view">
                ...
                <div class="lightbox-media">
                    ...
                    <h2 class="lightbox-media-title" data-lightbox-caption>Title</h2>
                </div>
